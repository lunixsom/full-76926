...
const guestsInfo= [
    ["Juan Perez", STANDARD_ROOM, 101, "2024/01/10", "28444777", CONFIRMED,false],
...
/*     ["Lorena Medina", STANDARD_ROOM, 103, "2024/01/20", "74111000", CANCELED, false],
    ...
    ["Clara Ponce", DELUXE_ROOM, 109, "2024/02/18", "60155000", CANCELED, false],
...
// Armo la card con la info 
const ArmarCard = (fullName, roomType, roomNumber, chekIndate, passportNumber, status, dataVip) =>{
...
const guestsInfoContainer = document.getElementById("guestsInfo-container");
  ...
  guestsInfo.forEach((guestInfo) => {
   ...
   const dataVip = guestInfo[6];
    ...
    const listaCards = ArmarCard(fullName, roomType, roomNumber, chekIndate, passportNumber, status, dataVip);
    guestsInfoContainer.appendChild(listaCards);
});
